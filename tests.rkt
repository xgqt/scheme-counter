...
(module+ test
  ...
  (check-equal? ((c0+2 'get) 'val) 12)
  (check-equal? ((c1+2 'get) 'val) 13)
  (check-equal? ((c2+2 'get) 'val) 14)
  ...
  (check-equal? ((c0-2 'get) 'val) -12)
  (check-equal? ((c1-2 'get) 'val) -11)
  (check-equal? ((c2-2 'get) 'val) -10)
  ...
  (check-equal? ((c1*2 'get) 'val) 64)
  (check-equal? ((c2*2 'get) 'val) 128)
  ...
  (check-equal? ((c0/2 'get) 'val) 0)
  (check-equal? ((c1/2 'get) 'val) (/ 1 64))
  (check-equal? ((c2/2 'get) 'val) (/ 1 32))
